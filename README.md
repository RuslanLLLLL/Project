...
Каждый узел имеет мягкую цветную "подсветку снизу" (`drawGlow()`) — радиальный
градиент под карточкой, имитирующий подсветку светодиодной лентой снизу.
Яркость и радиус подсветки автоматически растут с ростом мощности потока узла
относительно `referencePowerKw` (простаивающий узел светится тускло-серым,
активный — ярко, цветом узла). Центральный узел Инвертора светится акцентным
цветом на средней яркости всегда, независимо от потоков — это "сердце" схемы,
и оно должно быть заметно в любом состоянии.
