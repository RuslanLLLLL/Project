...
//            действует. Диспетчер держит его ВСЕГДА = Battery First (01) -
//            согласовано с шагом 2 эвристики/структурой MILP-модели, где
//            излишки солнца всегда сперва идут на заряд СНЭ.
